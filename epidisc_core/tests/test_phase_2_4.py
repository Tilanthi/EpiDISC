...
def test_domain_system():
    ...
    try:
        ...
        from epidisc_core.domains.exoplanets import ExoplanetDomain
...
def test_physics_curriculum():
    ...
    try:
        from epidisc_core.physics import PhysicsCurriculum, ComplexityLevel
...
def test_validation_benchmarks():
    ...
    try:
        from epidisc_core.tests.validation_benchmarks import (
            ValidationSuite,
            BenchmarkResult,
...
def test_enhanced_system():
    ...
    try:
        from epidisc_core.core.unified_enhanced import (
