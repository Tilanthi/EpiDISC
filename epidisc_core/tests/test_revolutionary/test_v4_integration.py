...
# Project root is: ../ (from epidisc_core)
...
class TestV4Integration:
    ...
    def test_v4_coordinator_creation(self):
        ...
        from epidisc_core.v4_revolutionary import create_v4_coordinator
    ...
    def test_v4_process_query(self):
        ...
        from epidisc_core.v4_revolutionary import create_v4_coordinator, IntegrationMode
...
class TestMCEIntegration:
    ...
    def test_mce_creation(self):
        ...
        from epidisc_core.metacognitive.meta_context_engine import create_meta_context_engine
...
class TestASCIntegration:
    ...
    def test_asc_creation(self):
        ...
        from epidisc_core.self_teaching.autocatalytic_compiler import create_autocatalytic_self_compiler
...
class TestCRNIntegration:
    ...
    def test_crn_creation(self):
        ...
        from epidisc_core.reasoning.cognitive_relativity_navigator import create_cognitive_relativity_navigator
...
class TestMMOLIntegration:
    ...
    def test_mmol_creation(self):
        ...
        from epidisc_core.intelligence.multi_mind_orchestrator import create_multi_mind_orchestrator
    ...
    def test_specialized_minds(self):
        ...
        from epidisc_core.intelligence.specialized_minds import (
