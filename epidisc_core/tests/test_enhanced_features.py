...
def test_enhanced_features():
    ...
    from epidisc_core.self_teaching.embedding_novelty import (
    ...
    from epidisc_core.self_teaching.scientific_data import (
        PhysicsDataLibrary,
    ...
    from epidisc_core.self_teaching.multi_agent_swarm import (
    ...
    # Agent breakdown
    from epidisc_core.self_teaching.multi_agent_swarm import AgentRole
    agent_counts = {}
    ...
    from epidisc_core.self_teaching.arxiv_integration import (
