...
from epidisc_core.theoretical_discovery import (
...
def test_integration_with_astra_core():
    ...
    try:
        from epidisc_core import V6TheoreticalDiscovery, create_v6_theoretical_system
        print("  ✓ V6.0 components exported from epidisc_core")
