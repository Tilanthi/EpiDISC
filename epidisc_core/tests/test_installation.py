...
def test_basic_functionality():
    ...
    # Test SCM creation
    from epidisc_core.causal.model.scm import (
    ...
    from epidisc_core.memory.episodic.memory import Experience, EpisodicMemory
    ...
    # Test working memory
    from epidisc_core.memory.working.memory import WorkingMemory
    ...
    from epidisc_core.metacognitive.monitoring.monitor import CognitiveMonitor
