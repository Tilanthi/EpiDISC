...
def test_adaptive_reasoning_imports():
    ...
    from epidisc_core.scientific_discovery.adaptive_reasoning import (
...
def test_discovery_orchestrator_imports():
    ...
    from epidisc_core.scientific_discovery.discovery_orchestrator import (
...
def test_paper_library_imports():
    ...
    from epidisc_core.scientific_discovery.paper_library import PaperLibrary
...
def test_rag_query_imports():
    ...
    from epidisc_core.scientific_discovery.paper_rag_query import PaperRAGSystem
