...
try:
    from epidisc_core.capabilities.v101_temporal_causal import (
...
try:
    from epidisc_core.capabilities.v102_counterfactual_engine import (
...
try:
    from epidisc_core.capabilities.v103_multimodal_evidence import (
...
try:
    from epidisc_core.capabilities.v104_adversarial_discovery import (
...
try:
    from epidisc_core.capabilities.v105_meta_discovery import (
...
try:
    from epidisc_core.capabilities.v106_explainable_causal import (
...
try:
    from epidisc_core.capabilities.v107_discovery_triage import (
...
try:
    from epidisc_core.capabilities.v108_streaming_discovery import (
...
class V5DiscoveryOrchestrator:
    ...
    def _run_baseline_causal_discovery(
        ...
        try:
            from epidisc_core.capabilities.v98_fci_causal_discovery import create_fci_discovery
    ...
    def run_streaming_discovery(
        ...
        from epidisc_core.capabilities.v108_streaming_discovery import monitor_streaming_data
    ...
    def run_cross_domain_discovery(
        ...
        from epidisc_core.capabilities.v105_meta_discovery import meta_discovery_across_domains
