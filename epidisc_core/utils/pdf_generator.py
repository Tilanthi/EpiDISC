...
Author: BIODISC Project
Version: 2.0
Date: April 2026

Note: Originally developed for ASTRA, adapted for BIODISC.
"""
...
if __name__ == '__main__':
    ...
    print()
    print("Usage:")
    print("  from epidisc_core.utils.pdf_generator import PDFGenerator")
...
__all__ = [
    ...
    'ASTRAPDFGenerator',  # Legacy ASTRA name (backward compatibility)
    'PDFStyles',  # Recommended
    'BIODISCPDFStyles',  # Full BIODISC name
    'ASTRAPDFStyles',  # Legacy ASTRA name (backward compatibility)
    'MarkdownConverter',
    'WrappedTableCell',
